...
import {ChartGraphic} from '../../graphic/designer/chart.graphic/chart.graphic';
...
export class LinesChart extends Chart {
...
[['北京', BJData], ['上海', SHData], ['广州', GZData]].forEach(function (item, i) {
  series.push({
    ...
    },
    {
      ...
      data: (<any>item[1]).map(function (dataItem) {
        return {
